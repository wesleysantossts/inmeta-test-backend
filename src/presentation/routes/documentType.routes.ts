...
documentTypesRoutes.get('/', authMiddleware, async (req, res) => await DocumentTypesFactory().find(req, res));
documentTypesRoutes.post('/', authMiddleware, async (req, res) => await DocumentTypesFactory().create(req, res));
documentTypesRoutes.get('/:id', authMiddleware, async (req, res) => await DocumentTypesFactory().findAll(req, res));
